...
Permitir autenticação segura de integrações externas.
...
- Chaves são independentes de usuários.
- Persistir apenas hash da chave.
- Permitir revogação.
...
- Chave válida autentica integração.
- Chave revogada deixa de funcionar.

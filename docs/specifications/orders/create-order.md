...
Registrar um pedido de uma única marca e ciclo.
...
- Itens armazenam snapshot dos preços.
- Pedido inicia como OPEN.
...
- Mistura de marcas no mesmo pedido é rejeitada.
- Idempotency-Key evita duplicação.

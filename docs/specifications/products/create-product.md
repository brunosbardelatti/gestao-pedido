...
Cadastrar um produto reutilizável em pedidos e vendas.
...
- A chave de negócio é marca + código.
- Descrição, marca e categoria são obrigatórias.
- Preço sugerido é opcional.
...
- Produto válido é criado.
- Código duplicado na mesma marca retorna 409.

...
Interpretar XML e criar um rascunho de pedido para revisão humana.
...
- Somente XML é suportado nesta primeira versão.
- Importação nunca recebe pedido automaticamente.
- Dados importados criam rascunho.
- Usuário deve revisar e confirmar.
- Operação usa idempotência e auditoria.
...
- XML válido cria rascunho.
- XML inválido retorna erros de validação.
- Reenvio com a mesma chave não duplica o rascunho.

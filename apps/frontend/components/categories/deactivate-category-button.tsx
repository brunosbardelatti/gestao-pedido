  ...
  async function deactivate(): Promise<void> {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setRequestError(
          body.error?.message ?? 'NÃ£o foi possÃ­vel inativar a categoria.',
        );
  ...
  if (!active) {
    return (
      <div className="mt-10 max-w-xl border-t border-border pt-7">
        <p className="text-sm font-semibold">SituaÃ§Ã£o da categoria</p>
        <div
          role="status"
  ...
  return (
    <div className="mt-10 max-w-xl border-t border-border pt-7">
      ...
      {isConfirming ? (
        <div
          role="group"
          aria-label={`Confirmar inativaÃ§Ã£o de ${categoryName}`}
        ...
        >
          <p className="flex items-start gap-2 text-sm text-foreground">
            <TriangleAlert
              ...
              aria-hidden
            />
            <span>Confirmar inativaÃ§Ã£o de {categoryName}?</span>
          </p>

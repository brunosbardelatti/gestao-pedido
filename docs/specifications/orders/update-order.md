...
Editar cabeçalho e itens de um pedido ainda não recebido.
...
- Somente pedidos OPEN podem ser editados.
- Recebidos e cancelados são imutáveis, exceto por operações de estorno definidas.
...
- Pedido aberto é atualizado.
- Pedido recebido retorna erro de regra de negócio.

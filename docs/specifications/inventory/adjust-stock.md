...
Registrar correção, uso pessoal ou devolução.
...
- Tipos permitidos: CORRECTION, PERSONAL_USE e RETURN.
- Motivo obrigatório.
- Operação deve ser auditada.
- Estoque negativo é permitido apenas após confirmação explícita.
...
- Ajuste cria movimentação.
- Ajuste que deixa estoque negativo exige confirmação.

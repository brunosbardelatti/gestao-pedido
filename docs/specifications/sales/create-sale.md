...
Registrar uma venda com um ou mais produtos e baixar o estoque.
...
- Cliente é opcional.
- Cada item sugere o preço cadastrado, mas permite edição manual.
- Forma de pagamento é opcional.
- Itens armazenam snapshot do valor vendido.
- Estoque negativo é permitido com alerta e confirmação.
- A operação é transacional e idempotente.
...
- Venda válida é criada.
- Movimentações de saída são registradas.

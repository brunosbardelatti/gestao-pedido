...
Permitir revisão e aprovação humana de um pedido criado por integração.
...
- A aprovação transforma o rascunho em pedido OPEN.
- Usuário pode corrigir produtos, quantidades e preços antes de aprovar.
- A aprovação ainda não movimenta estoque.
...
- Rascunho aprovado vira pedido aberto.
- Rascunho rejeitado não altera estoque.
...
- `POST /api/v1/integrations/imported-orders/{id}/approve`

...
Cancelar uma venda e devolver seus itens ao estoque.
...
- Venda não deve ser apagada.
- Cancelamento gera movimentações de estorno.
- Operação deve ser auditada e idempotente.
...
- Venda passa para CANCELED.
- Estoque é recomposto.

...
Atualizar os dados atuais de um produto.
...
- Alterações não podem modificar snapshots de pedidos e vendas anteriores.
- Marca + código deve continuar único.

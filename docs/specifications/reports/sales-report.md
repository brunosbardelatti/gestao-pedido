...
- Exibir faturamento, quantidade de vendas e itens vendidos.
- Ignorar ou destacar vendas canceladas conforme filtro.
...
- Totais correspondem às vendas válidas no período.

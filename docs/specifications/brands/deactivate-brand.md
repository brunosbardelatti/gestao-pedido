...
Impedir o uso de uma marca em novos cadastros sem apagar o histórico.
...
- A inativação não remove produtos ou pedidos históricos.
- Marcas inativas não podem ser usadas em novos produtos ou pedidos.
...
- Marca é inativada sem perda de histórico.

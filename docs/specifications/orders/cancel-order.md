...
Cancelar um pedido que não seguirá o fluxo normal.
...
- Pedido OPEN pode ser cancelado.
- Pedido RECEIVED não pode ser apagado; eventual reversão deve gerar estorno.
...
- Pedido aberto passa para CANCELED.
- Nenhum estoque é movimentado ao cancelar pedido aberto.

...
Impedir que um produto seja usado em novas operações.
...
- Produto não deve ser apagado fisicamente.
- Histórico e estoque permanecem consultáveis.
...
- Produto inativo não aparece por padrão em seletores de novas operações.

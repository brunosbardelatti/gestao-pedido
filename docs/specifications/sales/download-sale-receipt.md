...
Gerar um PDF simples com o resumo da venda.
...
- O documento não é fiscal.
- Deve conter dados da revendedora, cliente quando informado, itens, quantidades, valores, total e forma de pagamento quando informada.
...
- PDF é gerado para venda existente.
- Venda inexistente retorna 404.

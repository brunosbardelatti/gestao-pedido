...
Calcular margem usando snapshots de custo e venda.
...
- Usar valor de compra do item recebido/pedido e valor vendido do item da venda.
...
- Alterações no cadastro não mudam resultados históricos.

...
Permitir consulta rápida ao catálogo.
...
- Permitir filtros por marca, categoria e situação.
...
- Consulta retorna resultados paginados.
- Busca parcial por descrição funciona.

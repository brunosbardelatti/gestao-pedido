...
Exibir o saldo calculado por produto.
...
- Saldo é derivado de movimentações.
- Deve permitir pesquisa por produto.
- Estoque negativo deve ser exibido claramente.
...
- Saldo corresponde à soma das movimentações.
- Produtos sem movimentação podem aparecer com saldo zero quando filtrados.
